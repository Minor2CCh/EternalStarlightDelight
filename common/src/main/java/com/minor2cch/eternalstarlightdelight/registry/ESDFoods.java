...
public final class ESDFoods {
    ...
    public static final Supplier<FoodProperties> ABYSSAL_JUICE = Suppliers.memoize(() -> new FoodProperties.Builder().alwaysEdible().effect(new MobEffectInstance(MobEffects.WATER_BREATHING, 600, 0), 1.0F).build());
    ...
    public static final Supplier<FoodProperties> CRINOA_BREAD = Suppliers.memoize(() -> new FoodProperties.Builder()
            .nutrition(6).saturationModifier(0.6f).effect(new MobEffectInstance(ModEffects.NOURISHMENT, 600, 0), 1.0F).build());
    public static final Supplier<FoodProperties> MARIMOLD_STEW = Suppliers.memoize(() -> new FoodProperties.Builder().nutrition(8).saturationModifier(0.6F).effect(new MobEffectInstance(ModEffects.COMFORT, 3600, 0), 1.0F).effect(new MobEffectInstance(MobEffects.GLOWING, 600, 0), 1.0F).build());
    ...
    public static final Supplier<FoodProperties> AURORA_DEER_DICE_STEAK_PASTA = Suppliers.memoize(() -> new FoodProperties.Builder().nutrition(14).saturationModifier(0.75F).effect(new MobEffectInstance(ModEffects.NOURISHMENT, 6000, 0), 1.0f).build());
    ...
    public static final Supplier<FoodProperties> AURORA_DEER_STEAK_SPECIAL_LUNCH = Suppliers.memoize(() -> new FoodProperties.Builder().nutrition(16).saturationModifier(0.75F).effect(new MobEffectInstance(ModEffects.NOURISHMENT, 3600, 0), 1.0f).effect(new MobEffectInstance(ModEffects.COMFORT, 3600, 0), 1.0f).effect(new MobEffectInstance(ESDMobEffects.STARFIRE_WARMTH, 3600, 0), 1.0f).build());
}
